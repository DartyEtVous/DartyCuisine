...
This module is an modification of contrib module save_draft
...
1) Copy the darty_brouillon folder to the modules folder in your installation.

2) Enable the module using Administer -> Site building -> Modules
   (/admin/build/modules).

3) Now when you create a new node, a 'Attente de publication' button will be
   added to the form.
